                            ...
                            <div style={{ width: "50%" }}>
                                ...
                                <form onSubmit={sendSol}>
                                    <div className="m-p-input-wrapper m-p-i-w-first" style={{ margin: "0px", borderBottom: "1px solid rgb(218, 224, 239)" }}><p className="p-i-label">Give:</p> <div className="input-prefix-w">
                                        <input type="number" step="0.01"  onChange={(e)=>setSolAmt(e.target.value)}  id='amount' placeholder='e.g. 0.1' required />
                ...
                }
                {
                    txSig ?
                        <div className='flex justify-center items-center mt-4'>
                            <p className=' font-normal'>View your transaction on- </p>
                            <a href={link()} className=' font-normal hover:text-[#512da8]'>Solana Explorer 🚀</a>
                        </div> :
                        null
                }
            </div>
